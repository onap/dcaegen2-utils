...
import static org.onap.dcae.utils.eelf.logger.logback.utils.LogUtils.getErrorLogSpec;
...
public class ErrorLogLayout extends LayoutBase<ILoggingEvent> {
    ...
    public String doLayout(final ILoggingEvent event) {
        ...
        final ErrorLogSpec errorLogSpec = getErrorLogSpec();
        ...
        return createLogMessageString(errorLogValues);
    }
}
