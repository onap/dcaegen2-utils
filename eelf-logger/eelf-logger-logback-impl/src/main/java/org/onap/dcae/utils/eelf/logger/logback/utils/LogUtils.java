...
import static org.onap.dcae.utils.eelf.logger.api.info.AppLogInfo.Defaults.DEFAULT_INSTANCE_UUID;
import static org.onap.dcae.utils.eelf.logger.api.info.AppLogInfo.Defaults.DEFAULT_SERVER_FQDN;
import static org.onap.dcae.utils.eelf.logger.api.info.AppLogInfo.Defaults.DEFAULT_SERVER_IP_ADDRESS;
import static org.onap.dcae.utils.eelf.logger.api.info.AppLogInfo.Defaults.DEFAULT_SERVICE_INSTANCE_ID;
import static org.onap.dcae.utils.eelf.logger.api.info.AppLogInfo.Defaults.DEFAULT_VIRTUAL_SERVER_NAME;
import static org.onap.dcae.utils.eelf.logger.logback.EELFLoggerDefaults.DEFAULT_APP_LOG_INFO;
import static org.onap.dcae.utils.eelf.logger.logback.EELFLoggerDefaults.DEFAULT_CUSTOM_FIELDS_LOG_INFO;
import static org.onap.dcae.utils.eelf.logger.logback.EELFLoggerDefaults.DEFAULT_ERROR_LOG_INFO;
import static org.onap.dcae.utils.eelf.logger.logback.EELFLoggerDefaults.DEFAULT_MISC_LOG_INFO;
import static org.onap.dcae.utils.eelf.logger.logback.EELFLoggerDefaults.DEFAULT_REQUEST_TIMING_LOG_INFO;
import static org.onap.dcae.utils.eelf.logger.logback.EELFLoggerDefaults.DEFAULT_RESPONSE_LOG_INFO;
import static org.onap.dcae.utils.eelf.logger.logback.EELFLoggerDefaults.DEFAULT_SERVICE_LOG_INFO;
import static org.onap.dcae.utils.eelf.logger.logback.EELFLoggerDefaults.DEFAULT_TARGET_SERVICE_LOG_INFO;
...
public abstract class LogUtils {
    ...
    public static AppLogSpec getAppLogSpec() {
        ...
        return appLogSpec == null ? new AppLogSpecImpl(DEFAULT_APP_LOG_INFO) : appLogSpec;
    }
    ...
    public static OptionalLogSpec getOptionalLogSpec(final Class<?> loggerClass, final LogLevelCategory
        ...
        if (optionalLogSpec != null) {
            ...
            if (optionalLogSpec.getCustomFieldsLogInfo() == null) {
                optionalLogSpec = optionalLogSpec.withCustomFieldsLogInfo(DEFAULT_CUSTOM_FIELDS_LOG_INFO);
            }
            // if misc fields log info is empty populate default values
            if (optionalLogSpec.getMiscLogInfo() == null) {
                optionalLogSpec = optionalLogSpec.withMiscLogInfo(DEFAULT_MISC_LOG_INFO);
            }
        } else {
    ...
    public static MetricLogSpec getMetricLogSpec() {
        ...
        if (metricLogSpec != null) {
            ...
            if (metricLogSpec.getServiceLogInfo() == null) {
                metricLogSpec = metricLogSpec.withServiceLogInfo(DEFAULT_SERVICE_LOG_INFO);
            }
            if (metricLogSpec.getRequestTimingLogInfo() == null || metricLogSpec.getBeginTimestamp() == null ||
                    metricLogSpec.getEndTimestamp() == null) {
                metricLogSpec = metricLogSpec.withRequestTimingLogInfo(DEFAULT_REQUEST_TIMING_LOG_INFO);
            }
            if (metricLogSpec.getResponseLogInfo() == null) {
                metricLogSpec = metricLogSpec.withResponseLogInfo(DEFAULT_RESPONSE_LOG_INFO);
            }
            ...
            if (metricLogSpec.getTargetServiceLogInfo() == null) {
                metricLogSpec = metricLogSpec.withTargetServiceLogInfo(DEFAULT_TARGET_SERVICE_LOG_INFO);
            }
        } else {
    ...
    public static ErrorLogSpec getErrorLogSpec() {
        ...
        if (errorLogSpec != null) {
            ...
            if (errorLogSpec.getServiceLogInfo() == null) {
                errorLogSpec = errorLogSpec.withServiceLogInfo(DEFAULT_SERVICE_LOG_INFO);
            }
            if (errorLogSpec.getTargetServiceLogInfo() == null) {
                errorLogSpec = errorLogSpec.withTargetServiceLogInfo(DEFAULT_TARGET_SERVICE_LOG_INFO);
            }
            if (errorLogSpec.getErrorLogInfo() == null) {
                errorLogSpec = errorLogSpec.withErrorLogInfo(DEFAULT_ERROR_LOG_INFO);
            }
    ...
    public static AuditLogSpec getAuditLogSpec() {
        ...
        if (auditLogSpec != null) {
            if (auditLogSpec.getServiceLogInfo() == null) {
                auditLogSpec = auditLogSpec.withServiceLogInfo(DEFAULT_SERVICE_LOG_INFO);
            }
            ...
            if (auditLogSpec.getResponseLogInfo() == null) {
                auditLogSpec = auditLogSpec.withResponseLogInfo(DEFAULT_RESPONSE_LOG_INFO);
            }

            if (auditLogSpec.getRequestTimingLogInfo() == null || auditLogSpec.getBeginTimestamp() == null ||
                    auditLogSpec.getEndTimestamp() == null) {
                auditLogSpec = auditLogSpec.withRequestTimingLogInfo(DEFAULT_REQUEST_TIMING_LOG_INFO);
            }
    ...
    private static OptionalLogSpecImpl createDefaultOptionalLogSpec(final Class<?> loggerClass,
        ...
        return new OptionalLogSpecImpl(createDefaultMessageLogInfo(logLevelCategory),
                createDefaultCodeLogInfo(loggerClass), DEFAULT_CUSTOM_FIELDS_LOG_INFO, DEFAULT_MISC_LOG_INFO);
    }
    ...
    public static AppLogInfoImpl createDefaultAppLogInfo() {
        final String serviceInstanceId =
                resolveProperty(null, DEFAULT_SERVICE_INSTANCE_ID,
                        "SERVICE_NAME", "ServiceInstanceId", "SERVICE_INSTANCE_ID");
        final String instanceUUID =
                resolveProperty(null, DEFAULT_INSTANCE_UUID,
                        "InstanceUUID", "INSTANCE_UUID");
        final String virtualServerName =
                resolveProperty(null, DEFAULT_VIRTUAL_SERVER_NAME,
                        "VirtualServerName", "VIRTUAL_SERVER_NAME");
        final String serverIPAddress = getHostIPAddress() != null ? getHostIPAddress() : DEFAULT_SERVER_IP_ADDRESS;
        final String serverFQDN = getHostName() != null ? getHostName() : DEFAULT_SERVER_FQDN;
